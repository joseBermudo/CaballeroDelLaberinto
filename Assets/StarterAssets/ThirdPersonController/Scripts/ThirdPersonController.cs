...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            if(GameControllerScr.estado == GameControllerScr.Estados.Juego){
            _hasAnimator = TryGetComponent(out _animator);
        ...
        private void Pause(){
            if(GameControllerScr.estado == GameControllerScr.Estados.Juego&&_input.pause){
                _input.pause = false;
                audioSource.Stop();
                GameControllerScr.SetPausa();
            }else if(GameControllerScr.estado == GameControllerScr.Estados.Pausa&&_input.pause){
                 _input.pause = false;
                 audioSource.Play();
                GameControllerScr.SetJuego();
            }
        }
